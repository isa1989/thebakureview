# Generated by Django 4.0 on 2024-10-15 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(blank=True, related_name='%(class)s_authors', to='core.Author')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200)),
                ('thumbnail', models.ImageField(upload_to=core.models.get_image_upload_thumbnail)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('source_model', models.CharField(max_length=50)),
                ('authors', models.ManyToManyField(blank=True, to='core.Author')),
            ],
            options={
                'verbose_name': 'Manşet',
